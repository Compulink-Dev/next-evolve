    ...
    return (
        <div className="text-slate-400 flex flex-col w-36 items-center justify-center">
            <div className="bg-purple-200 h-36 w-36 rounded-3xl flex items-center justify-center">
                <Image src={partner.image} alt={partner.name} className="object-contain w-full h-full" width={100} height={100} />
            </div>
        ...
        <div className="bg-purple-950">
            ...
            {partners.length > 0 ? (
                ...
                <div className="text-center text-slate-300 py-12">
                    <p className="text-2xl font-bold">No partners available at this time</p>
                </div>
            )}
        </div>
    );
